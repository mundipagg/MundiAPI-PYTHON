...
"""
    mundiapilib.models.get_subscription_item_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("discounts") != None:
            ...
            for structure in dictionary.get("discounts"):
                discounts.append(mundiapilib.models.get_discount_response.GetDiscountResponse.from_dictionary(structure))
