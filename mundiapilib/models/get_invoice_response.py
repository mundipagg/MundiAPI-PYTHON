...
"""
    mundiapilib.models.get_invoice_response

    This file was automatically generated by APIMATIC v2.0 ( https://apimatic.io )
"""
from mundiapilib.api_helper import APIHelper
import mundiapilib.models.get_invoice_item_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("items") != None:
            ...
            for structure in dictionary.get("items"):
                items.append(mundiapilib.models.get_invoice_item_response.GetInvoiceItemResponse.from_dictionary(structure))
        ...
        cycle = mundiapilib.models.get_period_response.GetPeriodResponse.from_dictionary(dictionary.get("cycle")) if dictionary.get("cycle") else None
