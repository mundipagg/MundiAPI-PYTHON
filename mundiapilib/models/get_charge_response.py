...
class GetChargeResponse(object):
    ...
    def from_dictionary(cls,
        ...
        last_transaction = mundiapilib.models.get_transaction_response.GetTransactionResponse.from_dictionary(dictionary.get("last_transaction")) if dictionary.get("last_transaction") else None
        invoice = mundiapilib.models.get_invoice_response.GetInvoiceResponse.from_dictionary(dictionary.get("invoice")) if dictionary.get("invoice") else None
        order = mundiapilib.models.get_order_response.GetOrderResponse.from_dictionary(dictionary.get("order")) if dictionary.get("order") else None
