...
"""
    mundiapilib.models.get_plan_item_response
...
class GetPlanItemResponse():
    ...
    def from_dictionary(cls,
        ...
        plan = mundiapilib.models.get_plan_response.GetPlanResponse.from_dictionary(dictionary.get("plan")) if dictionary.get("plan") else None
