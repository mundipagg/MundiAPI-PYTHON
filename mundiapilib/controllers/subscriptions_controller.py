...
"""
    mundiapilib.controllers.subscriptions_controller
...
class SubscriptionsController(BaseController):
    ...
    def get_subscription_invoices(self,
                                  subscription_id):
        """Does a GET request to /subscriptions/{subscription_id}/invoices.
        ...
        # Prepare query URL
        _query_builder = Configuration.base_uri
        _query_builder += '/subscriptions/{subscription_id}/invoices'
        _query_builder = APIHelper.append_url_with_template_parameters(_query_builder, { 
            'subscription_id': subscription_id
        })
        _query_url = APIHelper.clean_url(_query_builder)
    ...
    def update_subscription_credit_card(self,
                                        body,
                                        subscription_id):
        """Does a PATCH request to /subscriptions/{subscription_id}/credit-card.

        Updates the credit card from a subscription

        Args:
            body (UpdateSubscriptionCreditCardRequest): Request for updating a
                credit card
            subscription_id (string): Subscription id
        ...
        # Prepare query URL
        _query_builder = Configuration.base_uri
        _query_builder += '/subscriptions/{subscription_id}/credit-card'
        _query_builder = APIHelper.append_url_with_template_parameters(_query_builder, { 
            'subscription_id': subscription_id
        })
        _query_url = APIHelper.clean_url(_query_builder)
    ...
    def update_subscription_payment_method(self,
        ...
        Args:
            body (UpdateSubscriptionPaymentMethodRequest): Request for
                updating the payment method from a subscription
            subscription_id (string): Subscription id
