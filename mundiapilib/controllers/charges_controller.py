...
"""
    mundiapilib.controllers.charges_controller
...
class ChargesController(BaseController):
    ...
    def update_charge_credit_card(self,
                                  charge_id,
                                  request):
        """Does a PATCH request to /charges/{charge_id}/credit-card.

        Updates the credit card from a charge

        Args:
            charge_id (string): Charge id
            request (UpdateChargeCreditCardRequest): Request for updating a
                charge's credit card
        ...
        # Prepare query URL
        _query_builder = Configuration.base_uri
        _query_builder += '/charges/{charge_id}/credit-card'
        _query_builder = APIHelper.append_url_with_template_parameters(_query_builder, { 
            'charge_id': charge_id
        })
        _query_url = APIHelper.clean_url(_query_builder)
